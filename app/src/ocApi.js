...
const DEBUG_fakeEvents = [
    {
        ...
        "event_description": "The topic for Taking Sides Chapel this week, Friday October 9 is In the upcoming U.S. Presidential election, does your vote matter? Rae Creech will say No and Anna Ewing will say Yes",
        "event_start": DEBUG_genEventStart(),
        "event_end": DEBUG_genEventEnd(),
        "event_location": "Baugh Auditorium",
        "event_private": false,
        "event_contact_id": "1001342",
        "event_contact_show_name": true,
        "event_contact_show_phone": true,
        "event_contact_show_email": true,
        "contact_name": "Brian Simmons",
    ...
    .then((r) => {
        ...
        r.forEach(e => {
            result.push({
                ...
                event_show_description: (e.Description != null && e.Description != ""),
                ...
                event_contact_show_name: (e.ContactName != null && e.ContactName != "" && e.ContactName != "n/a"),
